  ...
  return (
    <main className="min-h-screen bg-[#f6f0e7] px-6 py-12 text-stone-950">
      <div className="mx-auto max-w-3xl rounded-[2rem] border border-amber-200 bg-white/85 p-8 shadow-2xl shadow-stone-900/10">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight">Connect Neon and Groq before studying</h1>
        <p className="mt-4 leading-7 text-stone-600">The app is implemented, but these environment variables are missing for runtime sync and transcription:</p>
